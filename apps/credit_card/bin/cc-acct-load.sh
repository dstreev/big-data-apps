...
datagencli -o $HOME/datasets/credit_card/acct/${ACCT_FILE} -c $COUNT -cfg ../generator/cc-acct.yaml
...
hdfs dfs -put $HOME/datasets/credit_card/acct/${ACCT_FILE}.csv /warehouse/tablespace/external/hive/${DATABASE}.db/cc_acct_delta/YEAR_MONTH=${PROC_CYCLE}
